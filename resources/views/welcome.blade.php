    ...
    <section class="resume-section" id="skills">
        <div class="resume-section-content">
            ...
            {{--<ul class="list-group list-group-horizontal dev-icons">
                ...
                <li class="list-group-item flex-fill h2"><i class="fab fa-java"></i> JAVA</li>
            </ul>
            <ul class="list-group list-group-horizontal dev-icons">
                <li class="list-group-item flex-fill h2"><i class="fab fa-js-square" ></i> JSCRIPT</li>
            ...
            {{--<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active flex-fill" data-bs-interval="10000">
                        <img src="/img/eundi.png" class="d-block w-200" alt="...">
                        <div class="carousel-caption d-none d-lg-block">
                            <p> <a href="https://github.com/AkmalKhairi/e-undiv2" class="text-secondary"> E-Undi</a> purpose is to create a system that is easy, clear, and efficient for the end user to use during the election in these Pandemic Covid-19 season.</p>
                        </div>
                    </div>
                    <div class="carousel-item flex-fill" data-bs-interval="10000">
                        <img src="/img/vms.png" class="d-block w-200" alt="...">
                        <div class="carousel-caption d-none d-lg-block">
                            <p><a href="https://github.com/AkmalKhairi/Premise-Visitor-Monitor-System" class="text-secondary">Visitor Monitoring System </a> was developed by my team during Workshop 2 to monitors
        ...
        <div class="resume-section-content">
            ...
            {{--<ul class="fa-ul mb-0">
                ...
                <li>
                    ...
                    2
                    <sup>nd</sup>
                    Place - Virtual Research and Innovation Exhibition UniMAP (EREKA) 2021
                </li>
                <li>
                    <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                    The Code 2018: Inter-Varsity Programming Contest
                </li>
                <li>
                    <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
